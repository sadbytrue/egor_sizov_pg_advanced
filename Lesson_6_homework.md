...
Таблица стала занимать на 1 порядок больше месте на диске, т.к. в результате 10 update всех строк таблицы появилось 10 000 000 "мертвых строк". Они появились т.к. отключен aurovacuum и место, занимаемое "мертвыми" строками не помечается, как доступное для записи на диске.
